...
<body>
    ...
    <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs">
            <li class="nav-item">
                <a class="nav-link" href="https://www.sciastra.com/">Home</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="https://www.sciastra.com/courses/">Courses</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="https://www.sciastra.com/selections/">Selections</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="https://www.sciastra.com/blog/">Blogs</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="https://www.sciastra.com/materials/">Materials</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="https://www.sciastra.com/teams/">Teams</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="https://www.sciastra.com/contact/">Contact Us</a>
            </li>
        </ul>
    </div>
				<!--end code-->
	...
	<script type="text/javascript">
		...
		function send_msg() {
			...
			jQuery('#input-me').val('');
			var isDeadlineQuery = txt.toLowerCase().includes('deadline');
			
			if (isDeadlineQuery) {
				jQuery.ajax({
					url: 'get_bot_message1.php',
					type: 'POST',
					dataType: 'json',
					data: {
						txt: txt
					...
					success: function(response) {
						var botHtml = '<li class="messages-you clearfix"><div class="message-body clearfix"><div class="message-header"><strong class="messages-title">Chatbot</strong> <small class="time-messages text-muted"><span class="fas fa-time"></span> <span class="minutes">' + getCurrentTime() + '</span></small> </div><p class="messages-p">' + response.html + '</p></div></li>';
						jQuery('.messages-list').append(botHtml);

						if (response.pageLink !== "") {
							var pageLinkHtml = '<li class="messages-you clearfix"><div class="message-body clearfix"><div class="message-header"><strong class="messages-title">Chatbot</strong> <small class="time-messages text-muted"><span class="fas fa-time"></span> <span class="minutes">' + getCurrentTime() + '</span></small> </div><p class="messages-p">' + response.pageLink + '</p></div></li>';
							jQuery('.messages-list').append(pageLinkHtml);
						}

						jQuery('.messages-box').scrollTop($('.messages-box')[0].scrollHeight);
